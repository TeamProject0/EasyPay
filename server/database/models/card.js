...
module.exports = {
    getAll: function (callback) {
      ...
      add: function(callback, values,iduser) {
        const q = "INSERT INTO card (cardnumber,cvv,balance,expiry,brand,users_idusers) VALUES (?,?,?,?,?,?)";
        conn.query(q, [values.cardnumber,values.cvv,values.balance,values.expiry,values.brand,iduser], function(err, results) {
